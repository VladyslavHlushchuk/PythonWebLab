...
class PortfolioViewsTests(BaseTestCase):
    ...
    def test_home_page_loads(self):
        ...
        with self.client:
            ...
            self.assertIn(u'Мене звати Владислав', response.data.decode('utf8'))
    ...
    def test_skills_page_loads(self):
        ...
        with self.client:
            ...
            self.assertEqual(response.status_code, 200)
            self.assertIn(u'Мої скіли', response.data.decode('utf8'))
    ...
    def test_contacts_page_loads(self):
        ...
        with self.client:
            ...
            self.assertEqual(response.status_code, 200)
            self.assertIn(u'Контакти', response.data.decode('utf8'))


    def test_study_page_loads(self):
        """
        GIVEN url to skills page
        WHEN the '/skills' page is requested (GET)
        THEN check that status code is 200 and response data contains 'My skills'
        ...
        with self.client:
            response = self.client.get(url_for('portfolio.study'))
            self.assertEqual(response.status_code, 200)
            self.assertIn(u'Мій досвід', response.data.decode('utf8'))
...
class AuthViewsTests(BaseTestCase):
    ...
    def test_login_page_loads(self):
        ...
        with self.client:
            ...
            self.assertEqual(response.status_code, 200)
            self.assertIn(u'Вхід', response.data.decode('utf8'))
    ...
    def test_registration_page_loads(self):
        ...
        with self.client:
            ...
            self.assertEqual(response.status_code, 200)
            self.assertIn(u'Реєстрація', response.data.decode('utf8'))
...
class AuthTests(BaseTestCase):
    ...
    def test_register_user_post(self):
        ...
        with self.client:
            ...
            self.assertIn(u'Створено акаунт для', respons.data.decode('utf8'))
    ...
    def test_login_user_without_remember_me(self):
        ...
        with self.client:
            ...
            self.assertIn(u'Успішний вхід на головну сторінку', response.data.decode('utf8'))
    ...
    def test_login_user_with_remember_me(self):
        ...
        with self.client:
            ...
            self.assertIn(u'Успішний вхід', response.data.decode('utf8'))
            assert response.status_code == 200
            assert current_user.is_authenticated == True
    ...
    def test_logout_user(self):
        ...
        with self.client:
            ...
            self.assertIn(u'Ви вийшли з системи', response.data.decode('utf8'))
            assert response.status_code == 200
